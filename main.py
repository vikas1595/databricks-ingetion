...
if __name__=='__main__':
    ...
    StructField("emp_id", IntegerType(), False),  # False = NOT NULL
    StructField("department", StringType(), True),  # True = Nullable
    StructField("salary", IntegerType(), True)
])

    # Create DataFrame
    employee_df = spark.createDataFrame([(99, "Marketing", 38969)], schema=expected_schema)

    print(employee_df.show(5))